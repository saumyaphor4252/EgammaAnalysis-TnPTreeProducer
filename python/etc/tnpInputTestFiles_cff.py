...
filesMiniAOD_2024 = {
    ...
    'data' : cms.untracked.vstring('file:/eos/cms/store/group/phys_egamma/ssaumya/FineTuning/UpdatedMenu/PATstep_MINIAOD_RootFiles_Reference/stepPAT_MINIAOD_0.root')
    }
