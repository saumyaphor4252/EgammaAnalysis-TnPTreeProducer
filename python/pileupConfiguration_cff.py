...
def setPileUpConfiguration(process, options):
  ...
  elif '2024' in options['era']: from SimGeneral.MixingModule.mix_Run3_Flat55To75_PoissonOOTPU_cfi import mix#tmp
  elif '2025' in options['era']: from SimGeneral.MixingModule.mix_Run3_Flat55To75_PoissonOOTPU_cfi import mix#tmp
  ...
  elif '2024' in options['era']: data_pu_distribution = data_pu_distribs['2018_DATA_xSec69.2mb']#tmp
